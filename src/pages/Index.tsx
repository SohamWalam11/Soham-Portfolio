...
const Index = () => {
  ...
  // --- NEW: State for active internship filter ---
  ...
  // --- NEW: Internships data with categories ---
  const internships = [
    {
      title: "AI & ML Intern",
    ...
    {
      title: "BCG X Virtual Internship",
      company: "BCG X",
      period: "Virtual",
  ...
  // --- NEW: Filtered internships based on activeInternshipFilter ---
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <section id="about" className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-6">
          ...
          {/* --- NEW: Filter Buttons for Internships --- */}
          ...
          {/* --- NEW: Filtered Internships Display --- */}
